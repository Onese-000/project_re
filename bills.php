        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">MANDATORY BILLS</h3>
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Rent</td>
                                            <td>Fee paid for the rented space or unit</td>
                                            <td>14000</td>
                                            <!-- <td>admin</td> -->
                                        </tr>
                                        <tr>
                                            ...
                                            <td>Security</td>
                                            <td>Maintenance of the 24 hour security team and system</td>
                                            <td>1500</td>
                                            <!-- <td>member</td> -->
                                        </tr>
                                        <tr>
                                            ...
                                            <td>Sanitary</td>
                                            <td>garbage collection, sewage treatment and general upkeep of the public facilities</td>
                                            <td>1200</td>
                                            <!-- <td>developer</td> -->
                                        </tr>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Optional Bills</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            <th class="border-top-0">#</th>
                                            <th class="border-top-0">Typee</th>
                                            <th class="border-top-0">Description</th>
                                            <th class="border-top-0">Amount</th>
                                            <!-- <th class="border-top-0">Role</th> -->
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><i class="fa fa-dumbbell" ></i></td>
                                            <td>Gym </td>
                                            <td>Monthly Gym membership</td>
                                            <td>2500</td>
